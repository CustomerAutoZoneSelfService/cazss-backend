...
@Entity
@Table(name = "History", schema = "cazss",
...
public class HistoryEntity {
    ...
    public HistoryEntity(Integer historyId, UserEntity user, EndpointsEntity endpoint, Integer statusCode, LocalDateTime createdAt, List<HistoryDataEntity> historyData) {
