...
class UserFilterServiceTest {
  ...
  /**
   * Set up test data before each test method. This creates fresh instances of all mock objects to
  ...
  void getUserFiltersByServiceId_UserNotFound() {
    ...
    assertThrows(
        ServiceNotFoundException.class, () -> userFilterService.getUserFiltersByServiceId(1));
  }
  ...
  void createUserFilters_ValidationFailure() {
    ...
    assertThrows(ValidationException.class, () -> userFilterService.createUserFilters(request));
  }
  ...
  void createUserFilters_InvalidPatternIds() {
    ...
    assertThrows(
        ServiceNotFoundException.class, () -> userFilterService.createUserFilters(request));
  }
  ...
  void deleteUserFilter_NotFound() {
    ...
    assertThrows(ServiceNotFoundException.class, () -> userFilterService.deleteUserFilter(90, 1));
  }
}
